...
public class SignPdf {
	...
	public static byte[] sign(String password, String keyStorePath, InputStream signPdfSrc, String signImage, float x,
			float y) {
		PdfReader reader = null;
		ByteArrayOutputStream signPDFData = null;
		PdfStamper stp = null;
		...
		try {
			...
			signPDFData = new ByteArrayOutputStream();
			// 临时pdf文件
			File temp = new File(System.getProperty("user.dir") + "/file/", System.currentTimeMillis() + ".pdf");
			stp = PdfStamper.createSignature(reader, signPDFData, '\0', temp, true);
			stp.setFullCompression();
			PdfSignatureAppearance sap = stp.getSignatureAppearance();
			sap.setReason("数字签名，不可改变");
...
//				"e:/4444.png", 100, 290);
//				"e:/2222.jpg", 100, 290);
		byte[] fileData = sign("101012", "d:/sign/cert.p12", //
				"d:/sign/I20190000252771651.pdf", //
				"d:/sign/zdbg1231.png", -50, 290);
//				"e:/2222.jpg", 100, 290);
