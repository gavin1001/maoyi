...
public class HttpClientUtil {
	...
	public static HttpResponse getResponseByPost(String url,Map<String,String> headerMap,Map params, String charset) {
	...
	public static HttpResponse getResponseByPost1(String url,Map<String,String> headerMap,String params, String charset) {
		...
		try {
			...
			StringEntity entity1 = new StringEntity(params, HTTP.UTF_8);
	...
	public static HttpResponse getResponseByGet(String url,Map<String,String> headerMap,Map params, String charset) {
		HttpClient httpClient = null;
